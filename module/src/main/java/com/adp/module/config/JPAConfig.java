...
@EnableJpaRepositories(basePackages = "com.adp.module.repository")
@EntityScan("com.adp.mdule.entity")
public class JPAConfig {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        lfb.setPackagesToScan("com.adp.module.entities");
